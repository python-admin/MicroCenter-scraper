...
def parse(productList, csvWriter):
    for product in productList:
        ...
        formFactors = ["ATX", "eATX", "mATX", "mini DTX", "Mini-DTX", "mini-ITX", "Mini-ITX", "mini ITX", "mITX"]
        ...
        csvWriter.writerow([name, brand, socket, formFactor, price])
def start():
    ...
    fields = ['name', 'brand', 'socket', 'formFactor', 'price']
